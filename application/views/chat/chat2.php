...
<html>
    <head>
        ...
        <style>
            ...
            .popup-box .popup-head .popup-head-right2
            {
                float: right;
                opacity: 0.5;
            }
           
            .popup-box .popup-head .popup-head-right2 a
            {
                text-decoration: none;
                color: inherit;
            }
    ...
    <body>
        ...
        <script>
           ...
           (function() {
                ...
                $('.popup-box header').on('click', function() {
           ...
           //          });
            ...
            function register_popup(id, name)
            {
                ...
                element = element + '<div class="popup-head-right2"><a href="javascript:minimize(\''+ id +'\');">-</a></div>&nbsp;';
                element = element + '<div style="clear: both"></div></div><div class="popup-messages">';
                // element = element + '<input type="text" name="chat" style="position:fixed; bottom:1px; height:18px; width: 292px;"></div></div>';
